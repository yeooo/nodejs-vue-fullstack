 ...
 * @Description: 
 * @Autor: 庄佩芬
 * @Date: 2019-09-24 16:09:27
 * @LastEditors: 庄佩芬
 * @LastEditTime: 2019-09-27 16:40:33
 */
module.exports = app => {
  ...
  router.get('/news/init', async (req, res) => {
    ...
    const newsTitles = ["新皮肤预告丨姜子牙全新皮肤免费送", "西施即将上线丨浣纱溪边的沉鱼少女，峡谷里的控制大师！", "陈雪凝凝心演唱王昭君，#寻找王昭君#短视频活动开启", "特步企鹅跑·王者快跑昆明收官，夏日路跑盛宴完美落幕", "周年庆版本爆料④  全新活动玩法：你想变身大龙吗？"];
